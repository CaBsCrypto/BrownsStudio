    ...
    (
      <div
        style={{
          ...
          padding: "80px",
          background: "linear-gradient(135deg, #040a16 0%, #0a1428 50%, #040a16 100%)",
          color: "#e5e5e5",
      ...
      >
        ...
        <div
          style={{
            ...
            height: "500px",
            borderRadius: "50%",
            background: "radial-gradient(circle, rgba(147,158,181,0.15) 0%, transparent 70%)",
            display: "flex",
          }}
        />
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          ...
          >
            {locale === "en" ? "AI · Web · Bots · Engineering" : "IA · Web · Bots · Ingeniería"}
          </div>
          <div
            style={{
              fontSize: "76px",
