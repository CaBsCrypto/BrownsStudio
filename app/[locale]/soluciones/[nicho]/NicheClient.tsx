...
interface NicheClientProps {
  locale: string;
  nicho: string;
}

export default function NicheClient({ locale, nicho }: NicheClientProps) {
  ...
  const uiText = {
    es: {
      ...
      setupFee: "Desarrollo e integración desde 800.000 CLP (único)",
      mensualFee: "Mantenimiento mensual desde 125.000 CLP",
    ...
    en: {
      ...
      setupFee: "Development & integration from 800.000 CLP (one-time)",
      mensualFee: "Monthly maintenance from 125.000 CLP",
    ...
    pt: {
      ...
      setupFee: "Desenvolvimento e integração a partir de 800.000 CLP (único)",
      mensualFee: "Manutenção mensal a partir de 125.000 CLP",
