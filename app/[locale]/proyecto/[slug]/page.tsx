...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: proyecto.descripcion[lang],
    openGraph: {
...
export default async function ProyectoPage({ params }: Props) {
  ...
  const whatsappMsg = lang === "en" 
    ? `Hello, I saw the project ${proyecto.nombre} in your portfolio and I'd like to get a quote for something similar for my business.`
    : lang === "pt"
    ? `Olá, vi o projeto ${proyecto.nombre} no seu portfólio e gostaria de um orçamento para algo semelhante para o meu negócio.`
    : `Hola, vi el proyecto ${proyecto.nombre} en su portfolio y me gustaría cotizar algo similar para mi negocio.`;
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-10">
            ...
            >
              ...
              {lang === "en" ? "Back to portfolio" : lang === "pt" ? "Voltar ao portfólio" : "Volver al portfolio"}
            </Link>
            ...
            <div className="flex flex-wrap items-center gap-2 mb-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/20 bg-white/10 text-white text-xs font-medium backdrop-blur-sm">
                {proyecto.tipo[lang]} · {proyecto.año}
              </div>
              {proyecto.comingSoon && (
              ...
              <div className="lg:col-span-2 space-y-10">
                ...
                <div>
                  <h2 className="font-display font-bold text-2xl text-text-primary mb-4">
                    {lang === "en" ? "About this project" : lang === "pt" ? "Sobre este projeto" : "Sobre este proyecto"}
                  </h2>
                  <p className="text-text-secondary leading-relaxed">
                    {proyecto.descripcionLarga[lang]}
                  </p>
                </div>
                ...
                >
                  ...
                  <p className="text-xs text-accent-gold font-medium tracking-widest uppercase mb-2">
                    {lang === "en" ? "Result" : lang === "pt" ? "Resultado" : "Resultado"}
                  </p>
              ...
              <div className="space-y-6">
                ...
                <div className="rounded-2xl border border-white/5 bg-bg-secondary p-6">
                  <h3 className="font-display font-semibold text-text-primary mb-4">
                    {lang === "en" ? "Features" : lang === "pt" ? "Funcionalidades" : "Funcionalidades"}
                  </h3>
                  <ul className="space-y-3">
                    {proyecto.caracteristicas[lang].map((c) => (
                ...
                <div className="rounded-2xl border border-accent-gold/20 bg-gradient-to-b from-accent-gold/8 to-transparent p-6">
                  <h3 className="font-display font-semibold text-text-primary mb-2">
                    {lang === "en" ? "Like this style?" : lang === "pt" ? "Gosta deste estilo?" : "¿Te gusta este estilo?"}
                  </h3>
                  <p className="text-text-muted text-sm mb-5">
                    {lang === "en" 
                      ? "We can create something similar for your business. Tell us your idea."
                      : lang === "pt"
                      ? "Podemos criar algo semelhante para o seu negócio. Conte-nos sua ideia."
                  ...
                  >
                    ...
                    {lang === "en" ? "Quote similar project" : lang === "pt" ? "Orçar projeto semelhante" : "Cotizar proyecto similar"}
                  </a>
                  <Link
                    href={`/${lang}#portfolio`}
                  ...
                  >
                    {lang === "en" ? "See more projects" : lang === "pt" ? "Ver mais projetos" : "Ver más proyectos"}
                  </Link>
                </div>
              </div>
            </div>
