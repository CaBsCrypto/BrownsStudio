...
export const proyectos: Proyecto[] = [
  ...
  },
  {
    ...
    tipo: "Comunidad Web3",
    descripcion:
      "Hub para la primera convocatoria musical de PizzaDAO para el mundo hispanohablante. $350 USDC en premios y las canciones ganadoras serán la banda sonora del PizzaDAO Game.",
    descripcionLarga:
      "PizzaDAO necesitaba una plataforma para lanzar su concurso musical en la comunidad hispanohablante de Web3. Construimos el hub de la convocatoria con conexión de wallets, sistema de participación y presentación de premios en USDC. Las canciones ganadoras con licencia CC0 serán integradas como banda sonora oficial del juego de PizzaDAO, que se encuentra en desarrollo activo.",
    ...
    caracteristicas: [
      ...
      "Licencia CC0 para canciones ganadoras",
      "Integración con el PizzaDAO Game",
      "Diseño mobile-first",
      "Comunidad hispanohablante Web3",
    ],
    resultado: "Hub comunitario que lanzó la primera convocatoria musical de PizzaDAO en LATAM.",
    quote: "Ponle ritmo a la comunidad — la primera convocatoria musical de PizzaDAO para el mundo hispanohablante.",
    quoteAutor: "Pizza DAO",
  ...
  },
  {
    ...
    tipo: "Música + Web3",
    descripcion:
      "Plataforma conjunta con PizzaDAO para llevar la música al ecosistema Web3 hispanohablante. Concurso con $350 USDC y canciones con licencia CC0 como banda sonora del PizzaDAO Game.",
    descripcionLarga:
      "MusicaW3 y PizzaDAO unieron fuerzas para crear la primera convocatoria musical descentralizada del mundo hispanohablante. La plataforma permite a artistas participar conectando su wallet, subir su canción y competir por premios en USDC. Las obras ganadoras obtienen licencia CC0 y se convierten en la banda sonora oficial del juego de la comunidad.",
    tecnologias: ["Next.js", "TypeScript", "Tailwind CSS", "Web3", "Wallet Connect"],
    color: "linear-gradient(135deg, #1a0d2e 0%, #4a1272 50%, #7b2d8b 100%)",
    colorAccent: "#c084fc",
    caracteristicas: [
      "Plataforma musical descentralizada",
      "Participación con wallet",
      "Premios en USDC",
    ...
    quote: "Crea música con pizza y web3 — la primera convocatoria para el mundo hispanohablante.",
    quoteAutor: "Musica W3 x Pizza DAO",
    linkDemo: "https://pizzadao-mw3.vercel.app",
    año: 2025,
  },
  {
