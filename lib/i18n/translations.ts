export const translations = {
  en: {
    ...
    hero: {
      badge: "SALES & OPERATIONAL OPTIMIZATION · LIVE IN 7 DAYS",
      line1: "While you rest,",
      line2: "your business drives sales",
      line3: "and optimizes its schedule 24/7.",
      sub: "You focus on bringing potential clients; we handle and filter them so you can scale seamlessly. Take your business to the next level with us.",
      cta1: "Optimize my business",
      ...
      chatSims: [
        {
          ...
          hudValue: "$1,800 USD",
          prospect: "Hi, I'm interested in the clear aligner treatment, but I can only make it on Thursday afternoons. Any slots?",
          agent1: "Hi! Absolutely, I can help you book your assessment appointment. Let me check our specialist schedule for Thursdays...",
          tool1: "⚙️ Querying clinic schedule...",
          tool1Success: "✓ Open slots found for Thursday",
          agent2: "We have openings this Thursday at 4:30 PM or 6:00 PM with Dr. Araya. Do either of those work for you?",
          prospect2: "4:30 PM works perfectly for me.",
          tool2: "⚙️ Registering in CRM & booking slot...",
          tool2Success: "✓ Appointment booked ($1,800 USD) & Invites sent",
        ...
        },
        {
          ...
          hudValue: "$1,500 USD",
          prospect: "Hi, I wanted to ask about the facial rejuvenation treatment with Botox and fillers. Do you have slots this week?",
          agent1: "Hello! Great to hear from you. Yes, we have openings for facial aesthetic assessments. Let me check Dr. Rossi's schedule...",
          ...
          tool2Success: "✓ Session reserved ($1,500 USD) & SMS sent",
        ...
        },
        {
          ...
          hudValue: "$2,500 USD",
          prospect: "Hello, I need urgent legal advice to draft a high-value real estate purchase agreement. Do you have an attorney available?",
          agent1: "Hi! Certainly, we can assist you with an attorney specializing in corporate real estate. Let me check the schedule of our senior partner...",
          tool1: "⚙️ Filtering case by matter & valuation...",
          tool1Success: "✓ Case qualified for Senior Partner",
          agent2: "Our senior partner, Mr. Araya, has openings this Monday at 9:00 AM or 11:30 AM for a strategic session. Which fits best?",
          prospect2: "Monday at 11:30 AM is perfect.",
          tool2: "⚙️ Creating private Zoom room & logging case...",
          tool2Success: "✓ Premium consult booked ($2,500 USD)",
        ...
        },
        {
          ...
          hudValue: "$600 USD",
          prospect: "Hi, I'm looking for intensive tutoring to prepare for the advanced calculus college entry exam. Do you have math/physics tutors?",
          agent1: "Hello! Yes, we have expert engineering-certified tutors for advanced calculus. Let me check the available hours this week...",
          ...
          tool2Success: "✓ Intensive prep booked ($600 USD)",
        ...
        },
        {
          ...
          hudValue: "$1,200 USD",
          prospect: "Hello, I wanted to quote and book the comprehensive one-day executive health checkup. When do you have openings?",
          agent1: "Hello! Our Executive Premium checkup includes comprehensive testing and consultations in a single morning. Let me check clinical slots...",
          ...
          tool2Success: "✓ Premium checkup confirmed ($1,200 USD)",
      ...
      plans: [
        {
          ...
          price: "$500 USD",
          priceSuffix: " setup + $100/mo maintenance",
          features: [
        ...
        },
        {
          ...
          price: "$1,500+ USD",
          priceSuffix: " setup + $200/mo maintenance",
          features: [
        ...
        },
        {
          ...
          price: "Custom Quote",
          priceSuffix: " + $300+/mo maintenance",
          features: [
  ...
  es: {
    ...
    hero: {
      badge: "OPTIMIZACIÓN DE VENTAS Y OPERACIONES · EN VIVO EN 7 DÍAS",
      line1: "Mientras tú descansas,",
      line2: "tu negocio multiplica ventas",
      line3: "y optimiza su agenda 24/7.",
      sub: "Preocúpate de atraer potenciales clientes; nosotros nos encargamos de filtrarlos y gestionarlos para que puedas escalar de la mejor manera. Lleva tu negocio al siguiente nivel con nosotros.",
      cta1: "Optimizar mi negocio",
      ...
      chatSims: [
        {
          ...
          hudValue: "$1,800 USD",
          prospect: "Hola, me interesa el tratamiento de ortodoncia invisible pero solo puedo asistir los jueves por la tarde. ¿Tienen cupos?",
          agent1: "¡Hola! Claro que sí, con gusto te ayudo a agendar tu cita de evaluación. Déjame revisar el calendario de especialistas para los jueves...",
          tool1: "⚙️ Consultando agenda clínica...",
          tool1Success: "✓ Horarios libres encontrados para Jueves",
          agent2: "Tengo disponible este Jueves a las 4:30 PM o a las 6:00 PM con la Dra. Araya. ¿Te queda bien alguno?",
          prospect2: "Me sirve perfecto el de las 4:30 PM.",
          tool2: "⚙️ Registrando en CRM y reservando cita...",
          tool2Success: "✓ Cita agendada ($1,800 USD) & Notificaciones enviadas",
        ...
        },
        {
          ...
          hudValue: "$1,500 USD",
          prospect: "Buenas, quería consultar por el tratamiento de rejuvenecimiento facial con bótox y ácido hialurónico. ¿Tienen disponibilidad esta semana?",
          agent1: "¡Hola! Qué gusto saludarte. Sí, tenemos cupos disponibles para evaluación estética facial. Dejame verificar la disponibilidad del Dr. Rossi...",
          ...
          tool2Success: "✓ Evaluación reservada ($1,500 USD) & SMS enviado",
        ...
        },
        {
          ...
          hudValue: "$2,500 USD",
          prospect: "Hola, necesito asesoría urgente para redactar un contrato de compraventa inmobiliaria de alto valor. ¿Tienen algún abogado disponible?",
          agent1: "¡Hola! Claro, podemos asistirte con un abogado especialista en derecho inmobiliario corporativo. Voy a consultar la disponibilidad de nuestro socio principal...",
          tool1: "⚙️ Filtrando caso por materia y cuantía...",
          tool1Success: "✓ Caso calificado para Socio Senior",
          agent2: "Nuestro socio senior, el Dr. Araya, tiene libre el Lunes a las 9:00 AM o a las 11:30 AM para una sesión estratégica. ¿Qué hora te acomoda?",
          prospect2: "El Lunes a las 11:30 AM está perfecto.",
          tool2: "⚙️ Creando sala de Zoom privada y registrando caso...",
          tool2Success: "✓ Consulta premium agendada ($2,500 USD)",
        ...
        },
        {
          ...
          hudValue: "$600 USD",
          prospect: "Hola, busco clases de preparación intensiva para el examen de ingreso de cálculo avanzado. ¿Tienen tutores de física/matemática?",
          agent1: "¡Hola! Sí, contamos con tutores expertos titulados de ingeniería para cálculo avanzado. Déjame ver las horas disponibles esta semana...",
          ...
          tool2Success: "✓ Curso intensivo agendado ($600 USD)",
        ...
        },
        {
          ...
          hudValue: "$1,200 USD",
          prospect: "Hola, quería cotizar y agendar el programa de chequeo médico ejecutivo integral de un día. ¿Cuándo tienen vacantes?",
          agent1: "¡Hola! Un gusto. Nuestro programa Ejecutivo Premium incluye exámenes completos y consulta con especialista en una mañana. Déjame revisar el cupo clínico...",
          ...
          tool2Success: "✓ Chequeo integral agendado ($1,200 USD)",
      ...
      plans: [
        {
          ...
          price: "$500 USD",
          priceSuffix: " setup + $100/mes mantenimiento",
          features: [
        ...
        },
        {
          ...
          price: "$1,500+ USD",
          priceSuffix: " setup + $200/mes mantenimiento",
          features: [
        ...
        },
        {
          ...
          price: "A Cotizar",
          priceSuffix: " + $300+/mes mantenimiento",
          features: [
  ...
  pt: {
    ...
    hero: {
      badge: "OTIMIZAÇÃO DE VENDAS E OPERAÇÕES · NO AR EM 7 DIAS",
      line1: "Enquanto você descansa,",
      line2: "seu negócio multiplica vendas",
      line3: "e otimiza sua agenda 24/7.",
      sub: "Preocupe-se em atrair potenciais clientes; nós cuidamos de filtrá-los e gerenciá-los para que você possa escalar da melhor maneira. Leve seu negócio ao próximo nível conosco.",
      cta1: "Otimizar meu negócio",
      ...
      chatSims: [
        {
          ...
          hudValue: "$1.800 USD",
          prospect: "Olá, tenho interesse no tratamento de alinhadores invisíveis, mas só posso nas quintas-feiras à tarde. Vocês têm horários?",
          agent1: "Olá! Com certeza, posso te ajudar a agendar sua consulta de avaliação. Deixe-me verificar a agenda dos especialistas para quinta-feira...",
          tool1: "⚙️ Consultando agenda da clínica...",
          tool1Success: "✓ Horários livres encontrados para Quinta-feira",
          agent2: "Temos disponibilidade nesta Quinta-feira às 16h30 ou às 18h00 com a Dra. Araya. Algum desses horários funciona para você?",
          prospect2: "O das 16h30 funciona perfeito para mim.",
          tool2: "⚙️ Registrando no CRM e reservando consulta...",
          tool2Success: "✓ Consulta agendada ($1.800 USD) & Notificações enviadas",
        ...
        },
        {
          ...
          hudValue: "$1.500 USD",
          prospect: "Olá, gostaria de saber sobre o tratamento de rejuvenescimento facial com botox e preenchimento. Vocês têm horários esta semana?",
          agent1: "Olá! Que ótimo falar com você. Sim, temos horários para avaliação estética facial. Deixe-me consultar a agenda do Dr. Rossi...",
          tool1: "⚙️ Verificando agenda dermatológica...",
          ...
          tool2Success: "✓ Avaliação agendada ($1.500 USD) & SMS enviado",
        ...
        },
        {
          ...
          hudValue: "$2.500 USD",
          prospect: "Olá, preciso de assessoria jurídica urgente para elaborar um contrato de compra e venda de imóvel de alto valor. Tem advogado disponível?",
          agent1: "Olá! Sim, temos um advogado especialista em direito imobiliário corporativo. Deixe-me verificar a agenda do nosso sócio sênior...",
          tool1: "⚙️ Triando caso por matéria e valor...",
          tool1Success: "✓ Caso qualificado para Sócio Sênior",
          agent2: "Nosso sócio sênior, Dr. Araya, tem vaga nesta Segunda às 9h00 ou às 11h30 para uma sessão estratégica. Qual funciona melhor?",
          prospect2: "Segunda-feira às 11h30 é perfeito.",
          tool2: "⚙️ Criando sala Zoom privada e registrando caso...",
          tool2Success: "✓ Reunião premium agendada ($2.500 USD)",
        ...
        },
        {
          ...
          hudValue: "$600 USD",
          prospect: "Olá, procuro aulas de preparação intensiva para o exame de admissão de cálculo avançado. Vocês têm tutores?",
          agent1: "Olá! Sim, temos tutores formados em engenharia para cálculo avançado. Deixe-me ver as horas disponíveis esta semana...",
        ...
        },
        {
          ...
          hudValue: "$1.200 USD",
          prospect: "Olá, gostaria de cotar e agendar o programa de checkup médico executivo integral de um dia. Quando há vagas?",
          agent1: "Olá! Nosso programa Executivo Premium inclui exames e consultas completas em uma manhã. Deixe-me consultar a agenda clínica...",
          ...
          tool2Success: "✓ Checkup executivo agendado ($1.200 USD)",
      ...
      plans: [
        {
          ...
          price: "$500 USD",
          priceSuffix: " setup + $100/mês manutenção",
          features: [
        ...
        },
        {
          ...
          price: "$1.500+ USD",
          priceSuffix: " setup + $200/mês manutenção",
          features: [
        ...
        },
        {
          ...
          price: "Sob Medida",
          priceSuffix: " + $300+/mês manutenção",
          features: [
