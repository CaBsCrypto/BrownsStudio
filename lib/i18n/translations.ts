export const translations = {
  en: {
    ...
    hero: {
      ...
      sub: "You define the process. We build the agent that runs it. Autonomous software that works, learns, and scales — while you lead.",
      cta1: "Get free quote",
      cta2: "View services",
      stat1: "Clients",
  ...
  es: {
    ...
    hero: {
      ...
      sub: "Tú defines el proceso. Nosotros construimos el agente que lo ejecuta. Software autónomo que trabaja, aprende y escala — mientras tú lideras.",
      cta1: "Cotizar gratis",
      cta2: "Ver servicios",
      stat1: "Clientes",
  ...
  pt: {
    ...
    hero: {
      ...
      sub: "Você define o processo. Nós construímos o agente que o executa. Software autônomo que trabalha, aprende e escala — enquanto você lidera.",
      cta1: "Orçar grátis",
      cta2: "Ver serviços",
      stat1: "Clientes",
      stat2: "Certs. Google IA",
