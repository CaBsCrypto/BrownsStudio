      ...
      chatSims: [
        {
          ...
          agent1: "Hello! Our diagnostic consultation and 3D study starts from $140,000 (the final clear aligners treatment quote is delivered after this clinical assessment). I'd be happy to check availability for you. Let me search our specialist calendar for Thursday afternoons...",
        ...
        },
        {
          ...
          agent1: "Hello! Facial rejuvenation assessment session starts from $120,000 (depending on the specific areas to treat; the final customized budget is provided after your clinical session). We have openings for aesthetic assessments. Let me check Dr. Rossi's schedule...",
        ...
        },
        {
          ...
          agent1: "Hello! Yes, the diagnostic test and study plan cycle package starts from $95,000 (depending on the hours needed; a final study plan and quote is provided after the diagnostic test). We have engineering-certified tutors. Let me check the available hours this week...",
        ...
        },
        {
          ...
          agent1: "Hello! Our Executive Premium checkup starts from $115,000 (the final price is tailored and delivered once your medical history and clinical details are confirmed). Let me check clinical slots...",
        ...
        },
        {
          ...
          agent1: "Hello! I would be delighted to help you schedule your private consultation. Our premium custom brokerage advisory sessions have a fee of $150,000 (fully deductible if you close a lease or purchase with us). Let me check our exclusive agent's calendar for this Saturday morning...",
          ...
          tool2Success: "✓ Consultation scheduled (Ref. $150,000) & SMS sent",
      ...
      chatSims: [
        {
          ...
          agent1: "¡Hola! Con gusto te ayudo a agendar tu evaluación. Como referencia, la consulta diagnóstica y estudio 3D inicia desde $140.000 (el presupuesto final del tratamiento definitivo de ortodoncia se entrega tras esta evaluación clínica). Déjame revisar la agenda de especialistas para los jueves por la tarde...",
        ...
        },
        {
          ...
          agent1: "¡Hola! Sí, el ciclo de diagnóstico y plan de estudio inicial inicia desde $95.000 (según las horas semanales necesarias, el presupuesto final se entrega tras la prueba de diagnóstico). Déjame ver las horas disponibles esta semana...",
        ...
        },
        {
          ...
          agent1: "¡Hola! Nuestro programa preventivo básico de chequeo ejecutivo tiene un valor referencial desde $115.000 (el presupuesto definitivo y plan específico se entrega tras confirmar tus antecedentes médicos). Déjame revisar el cupo clínico...",
        ...
        },
        {
          ...
          agent1: "¡Hola! Con gusto te ayudo a coordinar tu sesión de asesoría. Nuestra sesión de consultoría y búsqueda personalizada premium tiene un valor de $150.000 (100% abonable al concretar la compra o arriendo con nosotros). Déjame verificar la disponibilidad de nuestro asesor para este sábado...",
          ...
          tool2Success: "✓ Asesoría agendada (Ref. $150.000) & SMS enviado",
      ...
      chatSims: [
        {
          ...
          agent1: "Olá! Com prazer te ajudo a agendar sua avaliação. Como referência, a consulta diagnóstica e estudo 3D inicia a partir de $140.000 (o orçamento final e personalizado do tratamento ortodôntico definitivo é entregue após esta avaliação clínica). Deixe-me verificar a agenda de especialistas para as tardes de quinta-feira...",
        ...
        },
        {
          ...
          agent1: "Olá! A sessão de avaliação e rejuvenescimento facial inicia a partir de $120.000 (dependendo das áreas a serem tratadas; o orçamento final e plano personalizado são entregues após a consulta de avaliação). Temos horários para avaliação estética facial. Deixe-me consultar a agenda do Dr. Rossi...",
          tool1: "⚙️ Verificando agenda dermatológica...",
        ...
        },
        {
          ...
          agent1: "Olá! Sim, o ciclo de teste de diagnóstico e plano de estudo inicial custa a partir de $95.000 (com base nas horas necessárias; o plano e valor final são entregues após o teste de diagnóstico). Deixe-me ver as horas disponíveis esta semana...",
        ...
        },
        {
          ...
          agent1: "Olá! Nosso programa preventivo básico de checkup executivo custa a partir de $115.000 (o orçamento final e exames específicos são entregues após a triagem médica inicial). Deixe-me consultar a agenda clínica...",
        ...
        },
        {
          ...
          agent1: "Olá! Com prazer ajudo você a agendar sua sessão de assessoria personalizada. Nossas sessões exclusivas de consultoria e busca premium têm uma taxa de $150.000 (100% dedutível ao fechar a compra ou locação conosco). Deixe-me verificar a agenda do nosso corretor VIP para este sábado de manhã...",
          ...
          tool2Success: "✓ Assessoria agendada (Ref. $150.000) & confirmação enviada",
