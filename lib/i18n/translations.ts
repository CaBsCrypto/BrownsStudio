      ...
      chatSims: [
        {
          ...
          agent1: "Hello! Our premium clear aligner treatment starts at $2,500 USD (which includes the 3D scan and all aligners). I'd be happy to check availability for you. Let me search our specialist calendar for Thursday afternoons...",
      ...
      chatSims: [
        {
          ...
          agent1: "¡Hola! Nuestro tratamiento de ortodoncia invisible premium inicia en $2,500 USD (incluye estudio 3D completo y todos los alineadores). Con gusto te ayudo a agendar tu evaluación. Déjame revisar la agenda de especialistas para los jueves por la tarde...",
      ...
      chatSims: [
        {
          ...
          agent1: "Olá! Nosso tratamento de alinhadores invisíveis premium inicia em $2.500 USD (inclui o escaneamento 3D e todos os alinhadores). Com prazer te ajudo a agendar sua avaliação. Deixe-me verificar a agenda de especialistas para as tardes de quinta-feira...",
