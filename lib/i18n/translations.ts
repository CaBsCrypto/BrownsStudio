export const translations = {
  en: {
    ...
    hero: {
      ...
      line2: "your agent closes deals",
      line3: "on WhatsApp.",
      sub: "Live in 7 days — your agent responds, books and qualifies leads 24/7 in your exact voice. No extra staff needed.",
      cta1: "Activate my agent",
      cta2: "View services",
      stat1: "Clients",
  ...
  es: {
    ...
    hero: {
      ...
      line2: "tu agente cierra ventas",
      line3: "en WhatsApp.",
      sub: "En vivo en 7 días — responde, agenda y califica leads 24/7 con tu lógica exacta. Sin contratar más personal.",
      cta1: "Activar mi agente",
      cta2: "Ver servicios",
      stat1: "Clientes",
  ...
  pt: {
    ...
    hero: {
      ...
      line2: "seu agente fecha vendas",
      line3: "no WhatsApp.",
      sub: "No ar em 7 dias — responde, agenda e qualifica leads 24/7 com sua lógica exata. Sem contratar mais pessoas.",
      cta1: "Ativar meu agente",
      cta2: "Ver serviços",
      stat1: "Clientes",
      stat2: "Certs. Google IA",
      stat3: "Satisfação",
