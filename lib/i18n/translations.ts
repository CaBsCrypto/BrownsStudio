      ...
      chatSims: [
        {
          ...
          agent1: "Hello! Our diagnostic consultation and 3D study starts from **140,000 CLP** (the final clear aligners treatment quote is delivered after this clinical assessment). I'd be happy to check availability for you. Let me search our specialist calendar for Thursday afternoons...",
          ...
          tool2Success: "✓ Appointment booked (Ref. 140,000 CLP) & Invites sent",
        ...
        },
        {
          ...
          agent1: "Hello! Facial rejuvenation assessment session starts from **120,000 CLP** (depending on the specific areas to treat; the final customized budget is provided after your clinical session). We have openings for aesthetic assessments. Let me check Dr. Rossi's schedule...",
          ...
          tool2Success: "✓ Session reserved (Ref. 120,000 CLP) & SMS sent",
        ...
        },
        {
          ...
          agent1: "Hi! For this type of corporate operation, we first classify the case matter and valuation to assign the right specialist partner (the project quote is delivered after the strategic session). Let me check the schedule of our senior partner...",
        ...
        },
        {
          ...
          agent1: "Hello! Yes, the diagnostic test and study plan cycle package starts from **95,000 CLP** (depending on the hours needed; a final study plan and quote is provided after the diagnostic test). We have engineering-certified tutors. Let me check the available hours this week...",
          ...
          tool2Success: "✓ Intensive prep booked (95,000 CLP)",
        ...
        },
        {
          ...
          agent1: "Hello! Our Executive Premium checkup starts from **115,000 CLP** (the final price is tailored and delivered once your medical history and clinical details are confirmed). Let me check clinical slots...",
          ...
          tool2Success: "✓ Premium checkup confirmed (115,000 CLP)",
        ...
        },
        {
          ...
          hudValue: "150,000 CLP",
          prospect: "Hi! I want to schedule a premium property search and custom brokerage advisory consultation this Saturday morning. What are the requirements and is there availability?",
          agent1: "Hello! I would be delighted to help you schedule your private consultation. Our premium custom brokerage advisory sessions have a fee of **150,000 CLP** (fully deductible if you close a lease or purchase with us). Let me check our exclusive agent's calendar for this Saturday morning...",
          ...
          tool2Success: "✓ Consultation scheduled (Ref. 150,000 CLP) & SMS sent",
      ...
      chatSims: [
        {
          ...
          agent1: "¡Hola! Con gusto te ayudo a agendar tu evaluación. Como referencia, la consulta diagnóstica y estudio 3D inicia desde **140.000 CLP** (el presupuesto final del tratamiento definitivo de ortodoncia se entrega tras esta evaluación clínica). Déjame revisar la agenda de especialistas para los jueves por la tarde...",
          ...
          tool2Success: "✓ Cita agendada (Ref. 140.000 CLP) & Notificaciones enviadas",
        ...
        },
        {
          ...
          agent1: "¡Hola! La sesión de evaluación y rejuvenecimiento facial inicia desde **120.000 CLP** (dependiendo de las zonas a tratar; el presupuesto final y plan personalizado se entregan tras tu evaluación clínica). Tenemos cupos disponibles para evaluación estética facial. Dejame verificar la disponibilidad del Dr. Rossi...",
          ...
          tool2Success: "✓ Evaluación reservada (Ref. 120.000 CLP) & SMS enviado",
        ...
        },
        {
          ...
          agent1: "¡Hola! Para este tipo de operaciones corporativas, primero clasificamos la materia y cuantía del caso para asignar al socio especialista adecuado (el presupuesto del proyecto se entrega tras la sesión estratégica). Voy a consultar la disponibilidad de nuestro socio principal...",
        ...
        },
        {
          ...
          agent1: "¡Hola! Sí, el ciclo de diagnóstico y plan de estudio inicial inicia desde **95.000 CLP** (según las horas semanales necesarias, el presupuesto final se entrega tras la prueba de diagnóstico). Déjame ver las horas disponibles esta semana...",
          ...
          tool2Success: "✓ Curso intensivo agendado (95.000 CLP)",
        ...
        },
        {
          ...
          agent1: "¡Hola! Nuestro programa preventivo básico de chequeo ejecutivo tiene un valor referencial desde **115.000 CLP** (el presupuesto definitivo y plan específico se entrega tras confirmar tus antecedentes médicos). Déjame revisar el cupo clínico...",
          ...
          tool2Success: "✓ Chequeo integral agendado (115.000 CLP)",
        ...
        },
        {
          ...
          hudValue: "150.000 CLP",
          prospect: "¡Hola! Me interesa agendar una consulta de asesoría y búsqueda de propiedades premium para este sábado en la mañana. ¿Cuáles son los requisitos y si tienen cupos?",
          agent1: "¡Hola! Con gusto te ayudo a coordinar tu sesión de asesoría. Nuestra sesión de consultoría y búsqueda personalizada premium tiene un valor de **150.000 CLP** (100% abonable al concretar la compra o arriendo con nosotros). Déjame verificar la disponibilidad de nuestro asesor para este sábado...",
          ...
          tool2Success: "✓ Asesoría agendada (Ref. 150.000 CLP) & SMS enviado",
          agent3: "¡Excelente! Tu sesión de asesoría personalizada está confirmada para este sábado a las 10:30 AM. Te acabo de enviar la ubicación de la oficina por WhatsApp y los datos de tu asesor asignado. ¡Que tengas un excelente día! 🏠"
        }
      ]
    },
    portfolio: {
      ...
      chatSims: [
        {
          ...
          agent1: "Olá! Com prazer te ajudo a agendar sua avaliação. Como referência, a consulta diagnóstica e estudo 3D inicia a partir de **140.000 CLP** (o orçamento final e personalizado do tratamento ortodôntico definitivo é entregue após esta avaliação clínica). Deixe-me verificar a agenda de especialistas para as tardes de quinta-feira...",
          ...
          tool2Success: "✓ Consulta agendada (Ref. 140.000 CLP) & Notificações enviadas",
        ...
        },
        {
          ...
          agent1: "Olá! A sessão de avaliação e rejuvenescimento facial inicia a partir de **120.000 CLP** (dependendo das áreas a serem tratadas; o orçamento final e plano personalizado são entregues após a consulta de avaliação). Temos horários para avaliação estética facial. Deixe-me consultar a agenda do Dr. Rossi...",
          tool1: "⚙️ Verificando agenda dermatológica...",
          ...
          tool2Success: "✓ Avaliação agendada (Ref. 120.000 CLP) & SMS enviado",
        ...
        },
        {
          ...
          agent1: "Olá! Para este tipo de operação corporativa, primeiro classificamos o caso por matéria e valor para designar o sócio especialista adequado (o orçamento final para elaboração é entregue após esta reunião estratégica). Deixe-me verificar a agenda do nosso sócio sênior...",
        ...
        },
        {
          ...
          agent1: "Olá! Sim, o ciclo de teste de diagnóstico e plano de estudo inicial custa a partir de **95.000 CLP** (com base nas horas necessárias; o plano e valor final são entregues após o teste de diagnóstico). Deixe-me ver as horas disponíveis esta semana...",
        ...
        },
        {
          ...
          agent1: "Olá! Nosso programa preventivo básico de checkup executivo custa a partir de **115.000 CLP** (o orçamento final e exames específicos são entregues após a triagem médica inicial). Deixe-me consultar a agenda clínica...",
          ...
          tool2Success: "✓ Checkup executivo agendado (115.000 CLP)",
        ...
        },
        {
          ...
          hudStatus: "Visita Agendada",
          hudValue: "150.000 CLP",
          prospect: "Olá! Tenho interesse em agendar uma consulta de assessoria e busca de imóveis premium para este sábado de manhã. Quais são os requisitos e se há vagas?",
          agent1: "Olá! Com prazer ajudo você a agendar sua sessão de assessoria personalizada. Nossas sessões exclusivas de consultoria e busca premium têm uma taxa de **150.000 CLP** (100% dedutível ao fechar a compra ou locação conosco). Deixe-me verificar a agenda do nosso corretor VIP para este sábado de manhã...",
          ...
          tool2Success: "✓ Assessoria agendada (Ref. 150.000 CLP) & confirmação enviada",
          agent3: "Excelente! Sua sessão de assessoria personalizada está confirmada para este sábado às 10h30. Enviei a localização exata do escritório por WhatsApp e as informações do seu corretor VIP. Tenha um ótimo dia! 🏠"
        }
      ]
    },
    portfolio: {
