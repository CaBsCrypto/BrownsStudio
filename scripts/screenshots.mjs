...
const PROYECTOS = [
  ...
  { slug: "pizza-dao",             url: "https://pizzadao-mw3.vercel.app" },
  { slug: "musica-w3",             url: "https://pizzadao-mw3.vercel.app" },
...
async function takeScreenshot(page, { slug, url }) {
  ...
  try {
    ...
    await page.waitForTimeout(800); // deja que animaciones terminen

    await page.screenshot({
      path: outPath,
      type: "jpeg",
      quality: 72,       // buen balance calidad/peso
...
async function main() {
  ...
  console.log(`\n✅ Listo en ${elapsed}s — imágenes en public/previews/`);
  console.log("   Siguiente paso: git add public/previews && git commit -m 'chore: refresh screenshots'");
  console.log("   Luego: vercel deploy --prod --yes\n");
}
