    ...
    tiers: [
      {
        ...
        msg: "Hi! I'm interested in the Agent Starter plan ($1,200 setup + $190/mo).",
        accent: "#c6c6c7",
        popular: false,
      },
      {
        ...
        cta: "Build my agent",
        msg: "Hi! I'm interested in the Agent Pro plan ($2,800 setup + $350/mo).",
        accent: "#00f0ff",
        popular: true,
      },
      {
        ...
        cta: "Book a call",
        msg: "Hi! I'd like to discuss an Enterprise Agentic System ($800+/mo).",
        accent: "#c8a45e",
        popular: false,
      },
    ],
    ...
    tiers: [
      {
        ...
        price: "$1,200",
        period: " setup",
        setup: "+ $190/mes de mantenimiento",
        ...
        msg: "¡Hola! Me interesa el plan Agent Starter ($1,200 setup + $190/mes).",
        accent: "#c6c6c7",
        popular: false,
      },
      {
        ...
        price: "$2,800+",
        period: " setup",
        setup: "+ $350/mes de mantenimiento",
        ...
        msg: "¡Hola! Me interesa el plan Agent Pro ($2,800 setup + $350/mes).",
        accent: "#00f0ff",
        popular: true,
      },
      {
        ...
        price: "A cotizar",
        period: "",
        setup: "+ $800+/mes de mantenimiento",
        ...
        cta: "Agendar llamada",
        msg: "¡Hola! Me gustaría hablar sobre un Sistema Agéntico Empresarial ($800+/mes).",
        accent: "#c8a45e",
        popular: false,
      },
    ],
    ...
    tiers: [
      {
        ...
        msg: "Olá! Tenho interesse no plano Agent Starter ($1.200 setup + $190/mês).",
        accent: "#c6c6c7",
        popular: false,
      },
      {
        ...
        msg: "Olá! Tenho interesse no plano Agent Pro ($2.800 setup + $350/mês).",
        accent: "#00f0ff",
        popular: true,
      },
      {
        ...
        cta: "Agendar chamada",
        msg: "Olá! Gostaria de falar sobre um Sistema Agêntico Empresarial ($800+/mês).",
        accent: "#c8a45e",
        popular: false,
      },
    ],
